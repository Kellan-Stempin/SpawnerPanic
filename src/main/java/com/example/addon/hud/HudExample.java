...
import com.example.addon.SpawnerPanicAddon;
...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(SpawnerPanicAddon.HUD_GROUP, "example", "HUD element example.", HudExample::new);
